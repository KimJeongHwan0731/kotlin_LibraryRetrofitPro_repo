...
import com.example.libraryretrofitpro.data.SeoulPublicLibraryInfo
...
class MainActivity : AppCompatActivity() {
    ...
    private fun loadLibraries() {
        ...
        service.getLibrarys(SeoulOpenApi.API_KEY, SeoulOpenApi.LIST_TOTAL_COUNT)
